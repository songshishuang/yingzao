...
2. **想把 skill 分享给同事或开源，没人敢装**——别人看不懂、不敢信、装了三分钟跑不通就放弃了；
3. **改了一版"感觉更好了"，其实不知道**——AI 帮你润色之后，到底是真变好，还是只是看起来更漂亮？

营造解决的就是这三件事：**给 skill 一把统一的尺子（九维评分），一套有证据的打磨流程（七步大修），和一份能反复使用的测试资产（改没改好，跑一下就知道）。** PM、研发、设计、运营写的 skill 都适用。
...
| **有证据的打磨** | 每轮改动有独立评审打分、有 patch 可回退 | "变好了"不靠感觉，靠改前/改后对比数据 |
...
**对你的价值**：这是营造和"让 AI 帮我改改"的本质区别——**改动是被测量的，不是被感觉的**。
...
营造打磨完每个 skill 会自我复盘（新模式、新反例记入台账）；**每打磨满 5 个 skill，它会主动要求"用自己打磨自己"**——你现在看到的营造，也会被它自己的尺子量。
