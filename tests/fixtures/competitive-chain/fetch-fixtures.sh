...
do_f2(){ fetch F2 github.com/alirezarezvani/claude-skills 4a3c05b69e64f4925f7fc65c88890f614f79caf0 c-level-advisor/c-level-agents/skills/caio-review 4082151af5f6a3966a45b8e5ac7a5e13b55065d5615574130df4f51954517e23; }
do_f3(){ fetch F3 github.com/coreyhaines31/marketingskills bee3f2f42c9ead9271af59a6d2082ed8aca8b3d3 skills/cold-email b7f8d793169a5111c857e5720c6b80028686cc95d5a0d0d6570957c2710aff9e; }
case "${1:-all}" in
  F2) do_f2 ;;
  F3) do_f3 ;;
  all) do_f2; do_f3 ;;
